...
class MessageServiceServer final {
public:
    explicit MessageServiceServer(grpc::Service* service);
    ~MessageServiceServer();

    MessageServiceServer(const MessageServiceServer&) = delete;
    MessageServiceServer& operator=(const MessageServiceServer&) = delete;
